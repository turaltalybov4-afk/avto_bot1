...
SERVICES = [
    {"name": "ТО", "price": 3000, "description": "Описание услуги", "aliases": ["техобслуживание"]},
    {"name": "Диагностика", "price": 1800, "description": "Описание услуги", "aliases": ["проверка"]},
    {"name": "Ремонт", "price": 4500, "description": "Описание услуги", "aliases": ["починка"]},
]

FAQ_ITEMS = [
    {
        "triggers": ["доставка", "привезете", "привоз"],
        "answers": [
            "Да, доставка есть. Подскажите адрес и удобное время, и все подтвердим.",
            "Доставляем ежедневно. Напишите район и когда вам удобно принять заказ.",
        ],
    },
    {
        "triggers": ["оплата", "перевод", "налич"],
        "answer": "Принимаем наличные и перевод. Для юрлиц можем выставить счет.",
    },
]
...
ORDER_START_KEYWORDS = ["заказать", "оформить", "нужна доставка", "оставить заявку"]
LEAD_PROMPT_QUANTITY = "Сколько нужно (например: 10 мешков по 25 кг)?"
LEAD_PROMPT_DATE = "Когда вам удобно: сегодня, завтра или другая дата?"
LEAD_PROMPT_CONTACT = "Оставьте телефон для подтверждения заказа."
LEAD_PROMPT_COMMENT = "Есть комментарий по адресу/подъезду? Если нет, напишите 'нет'."
LEAD_SUCCESS_TEXT = "Отлично, заявку приняли. Менеджер скоро свяжется для подтверждения."
LEAD_SKIP_WORDS = ["нет", "не", "-"]
MANAGER_LEAD_TITLE = "📥 Новая заявка из чата"
